...
class Create_Data:
    ...
    def make_swiss_roll(self):
        """
        creates dataset from hyper cube
        :return:
        """
        return datasets.make_swiss_roll(self.n_samples, noise=0.0, random_state=None, hole=False)
    ...
    def make_s_curve(self):
        ...
        :return:
        """
        return datasets.make_s_curve(self.n_samples, noise=0.0, random_state=None)
    ...
    def make_blobs(self):
        ...
        :return:
        """
        return datasets.make_blobs(self.n_samples, centers=3, n_features=2)


    def make_two_moons(self):
        return datasets.make_moons(n_samples=self.n_samples, noise=0.1,
